...
ifeq (${TARGET_FRAMEWORK},)
	CCM_DISTRIBUTION=cassandra dotnet test -p:BuildAllTargets=True src/Cassandra.IntegrationTests/Cassandra.IntegrationTests.csproj -l "console;verbosity=detailed"
else
