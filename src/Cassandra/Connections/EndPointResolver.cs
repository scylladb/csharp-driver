...
namespace Cassandra.Connections
{
    internal class EndPointResolver : IEndPointResolver
    {
        ...
        {
            return Task.FromResult((IConnectionEndPoint)new ConnectionEndPoint(new IPEndPoint(IPAddress.Parse(host.ContactPoint.StringRepresentation), shardAwarePort), _serverNameResolver, host.ContactPoint));
        }
