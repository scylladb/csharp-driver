...
namespace Cassandra
{
    ...
    public class Configuration
    {
        ...
        internal const bool DefaultDriverConfigReportingEnabled = true;
        ...
        /// <summary>
        /// An identifier for the created cluster instance. Generated by the driver unless explicitly set via
        /// <see cref="Builder.WithClusterId"/>, in which case it is application supplied and not guaranteed to
        /// be unique, so distinct <see cref="ICluster"/> instances may share the same value.
        /// </summary>
        ...
        /// <summary>
        /// <see cref="Builder.WithDriverConfigReporting"/>
        /// </summary>
        /// <remarks>
        /// This is captured once into the <see cref="StartupOptionsFactory"/> when this <see cref="Configuration"/>
        /// is built, since it is immutable afterwards; it is not re-read per control connection.
        /// </remarks>
        public bool DriverConfigReportingEnabled { get; }
                               ...
                               bool? driverConfigReportingEnabled = null)
        {
            ...
            DriverConfigReportingEnabled = driverConfigReportingEnabled ?? Configuration.DefaultDriverConfigReportingEnabled;
            StartupOptionsFactory = startupOptionsFactory ?? new StartupOptionsFactory(
                ClusterId,
                ApplicationVersion,
                ApplicationName,
