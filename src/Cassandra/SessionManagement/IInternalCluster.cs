...
namespace Cassandra.SessionManagement
{
    ...
    internal interface IInternalCluster : ICluster
    {
        ...
        /// <summary>
        /// Removes all cached client-side prepared statements with the provided server-side ID and prevents new
        /// callers from joining in-flight work for the provided query and keyspace.
        /// </summary>
        void InvalidatePreparedStatement(byte[] id, string cqlQuery, string keyspace);
